...
<img src="../media/plot_01_xinanjiang_b_parameter.png" alt="Xinanjiang b parameter effect on saturated fraction and infiltration capacity" width="800">

***Figure:*** *Effect of the Xinanjiang shape parameter $b$ on the saturated fraction $A_s$ (left) and the normalized potential infiltration capacity $INF_{pot}/w_{s1}$ (right). Low $b$ values approximate a simple bucket; high $b$ values produce sieve-like behavior where most water generates surface runoff.*
