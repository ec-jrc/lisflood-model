...
The total water volume ($q_{ch} \cdot L{ch}$) entering the river system is computed as explained in the chapter [channel routing](../2_15_stdLISFLOOD_channel-routing/index.md) is conveyed by the main channel, and, when the main channel flow capacity is exceeded, by the floodplain.
