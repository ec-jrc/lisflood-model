...
More specifically, $IntercSealed$ is equal to the total of rainfall and snow melt until all the depressions have been filled, that is until the $AvailableStorageSealed$ is larger than 0. The computation is shown by the following equations:
...
Direct runoff $R_d$ is added to [surface runoff](../2_14_stdLISFLOOD_surface-runnoff-routing/).  
