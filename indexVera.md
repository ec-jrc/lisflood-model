...
| Grad            | gradient.map    | U.: \[m m<sup>-1</sup>\]  <br> R.: map \> 0  **!!!**| Slope gradient  |
| Elevation Stdev | elvstd.map      | U.: \[m\]\ <dev> <br> R.: map ≥ 0 | Standard deviation of elevation       |
| **LAND USE -- fraction maps**   ||  |
| Fraction of water    | fracwater.map   | U.: \[-\] <dev> <br> R.: 0 ≤ map ≤ 1       | Fraction of inland water for each cell.  Values range from 0 (no water at all)  to 1 (pixel is 100% water)   |
...
| ChanGrad        | changrad.map    | U.: \[m m<sup>-1</sup>\]  <br> R.: map \> 0  **!!!** | Channel gradient |
