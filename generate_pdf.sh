...
echo "pandoc _pdf/*.md  --toc -V toc-title:\"Table of Contents\" --template=template.latex -f markdown+smart --pdf-engine=xelatex -o _pdf/manual.pdf -V geometry:margin=1.5cm"
