![](e:\media\/media/image1.png){width="7.35in"
height="0.22361111111111112in"}![](e:\media\/media/image2.png){width="8.266666666666667in"
height="1.9131944444444444in"}![](e:\media\/media/image3.png){width="0.9201388888888888in"
height="0.6131944444444445in"}

![](e:\media\/media/image4.emf){width="2.5118110236220472in"
height="2.9448818897637796in"}![](e:\media\/media/image5.emf){width="8.26736111111111in"
...
![](e:\media\/media/image6.emf){width="5.75in"
...
![](e:\media\/media/image7.emf){width="5.510416666666667in"
...
![](e:\media\/media/image8.png){width="5.511805555555555in"
...
![](e:\media\/media/image10.png){width="4.71875in" height="4.5in"}
...
![](e:\media\/media/image12.png){width="5.66875in" height="1.8125in"}
...
![](e:\media\/media/image12.png){width="5.677777777777778in"
height="3.025in"}
...
![](e:\media\/media/image24.emf){width="6.120138888888889in"
...
\\(\\begin{array}{l}\\left\\{ \\begin{array}{l}{S\_{\\max }} = 0.935 +
0.498 \\cdot LAI - 0.00575 \\cdot LA{I\^2} & & \[LAI \>
0.1\]\\\\{S\_{\\max }} = 0 & & & & & & \[LAI \\le 0.1\]\\end{array}
\\right.\\\\\\end{array}\\) (2-7)
...
\\({D\_{{\\mathop{\\rm int}} }} =
\\frac{1}{{{{\\rm{T}}\_{{\\rm{int}}}}}} \\cdot In{t\_{cum}}\\Delta t\\)
(2-11)
...
\\({T\_{\\max }} = {k\_{crop}} \\cdot ET0 \\cdot \[1 - \\exp ( -
{\\kappa \_{gb}} \\cdot LAI)\]\\Delta t - E{W\_{{\\mathop{\\rm int}}
}}\\) (2-14)
...
\\({r\_{WS}} = \\frac{{({w\_1} - {w\_{wp1}})}}{{({w\_{crit1}} -
{w\_{wp1}})}}\\) (2-15)
...
![](e:\media\/media/image26.emf){width="5.708333333333333in"
height="3.40625in"}
...
![](e:\media\/media/image27.emf){width="3.1979166666666665in"
height="2.9791666666666665in"}

**Figure 2.9** Soil moisture and potential infiltration capacity
relation

![](e:\media\/media/image28.emf){width="6.5in"
...
![](e:\media\/media/image34.emf){width="2.9895833333333335in"
height="2.875in"}
...
soil, *θ* \[mm^3^ mm^-3^\]) and \\(\\partial h(\\theta )/\\partial z\\)
is the matric potential gradient. If we assume a matric potential
gradient of zero, the equation reduces to:
...
\\({Q\_{uz}} = \\frac{1}{{{{\\rm{T}}\_{{\\rm{uz}}}}}} \\cdot
UZ\\,\\Delta t\\) (2-42)
...
\\({Q\_{lz}} = \\frac{1}{{{{\\rm{T}}\_{{\\rm{lz}}}}}} \\cdot
LZ\\;\\Delta t\\) (2-43)
...
![ROUTING](e:\media\/media/image35.png){width="6.0in"
...
![](e:\media\/media/image36.emf){width="5.802083333333333in"
...
![](e:\media\/media/image37.emf){width="5.625in"
...
![](e:\media\/media/image38.emf){width="5.989583333333333in"
...
![](e:\media\/media/image39.emf){width="5.447916666666667in"
height="7.40625in"}
...
![initLZDemo](e:\media\/media/image40.png){width="5.770833333333333in"
...
![](e:\media\/media/image41.emf){width="5.760416666666667in"
...
\\({O\_{res}} = \\min ({O\_{\\min }},\\frac{1}{{\\Delta t}}{\\kern 1pt}
F \\cdot S) & & & & & F \\le 2{L\_c}\\)

\\({O\_{res}} = {O\_{\\min }} + ({O\_{norm}} - {O\_{\\min }})\\frac{{(F
- 2{L\_c})}}{{({L\_n} - 2{L\_c})}} & & & & {L\_n} \\ge F \> 2{L\_c}\\)

\\({O\_{res}} = {O\_{norm}} + \\frac{{(F - {L\_n})}}{{({L\_f} -
{L\_n})}} \\cdot \\max \\{ ({I\_{res}} - {O\_{norm}}),({O\_{nd}} -
{O\_{norm}})\\} & {L\_f} \\ge F \> {L\_n}\\)

\\({O\_{res}} = \\max (\\frac{{(F - L\_f\^{})}}{{\\Delta t}}S,{O\_{nd}})
& & & & & F \> {L\_f}\\)
...
![reservoirPlacementNew](e:\media\/media/image42.png){width="4.75in"
height="2.125in"}
...
![polders](e:\media\/media/image43.png){width="5.770833333333333in"
...
> \\(\\begin{array}{l}{q\_{c,p}} = \\mu cb\\sqrt {2g}
> {h\_c}\^{{\\raise0.7ex\\hbox{\$3\$} \\!\\mathord{\\left/
>
> {\\vphantom {3 2}}\\right.\\kern-\\nulldelimiterspace}
>
> \\!\\lower0.7ex\\hbox{\$2\$}}};\\\\c = \\sqrt {1 - {{\\left\[
> {\\frac{{{h\_p}}}{{{h\_c}}}} \\right\]}\^{16}}} \\end{array}\\) (A2.1)
>
...
> \\(\\begin{array}{l}{q\_{p,c}} = \\mu cb\\sqrt {2g}
> {h\_p}\^{{\\raise0.7ex\\hbox{\$3\$} \\!\\mathord{\\left/
>
> {\\vphantom {3 2}}\\right.\\kern-\\nulldelimiterspace}
>
> \\!\\lower0.7ex\\hbox{\$2\$}}};\\\\c = \\sqrt {1 - {{\\left\[
> {\\frac{{{h\_c}}}{{{h\_p}}}} \\right\]}\^{16}}} \\end{array}\\) (A2.2)
...
![poldersRegulated](e:\media\/media/image44.png){width="5.395833333333333in"
...
![lakes](e:\media\/media/image45.png){width="5.375in"
...
![](e:\media\/media/image46.emf){width="6.0in"
...
A}}{{\\partial t}} = q\\) \\(\\rho {\\kern 1pt} gA({S\_0} - {S\_f}) =
0\\) where \\(A = \\alpha \\cdot {Q\^\\beta }\\)
...
![](e:\media\/media/image47.emf){width="5.864583333333333in"
height="2.75in"}
...
![](e:\media\/media/image48.emf){width="2.05in"
height="1.5270833333333333in"}![](e:\media\/media/image49.emf){width="1.9465277777777779in"
height="1.45in"}
...
![](e:\media\/media/image50.emf){width="4.033333333333333in"
...
![](e:\media\/media/image54.emf){width="3.142361111111111in"
height="1.3833333333333333in"}![](e:\media\/media/image55.emf){width="1.95in"
height="1.375in"}
...
![](e:\media\/media/image56.emf){width="4.0869564741907265in"
...
![chanDims](e:\media\/media/image57.png){width="5.770833333333333in"
...
![](e:\media\/media/image59.jpeg){width="1.3152777777777778in"
height="1.0847222222222221in"}![](e:\media\/media/image60.png){width="1.5930555555555554in"
height="0.7534722222222222in"}![](e:\media\/media/image61.png){width="8.266666666666667in"
